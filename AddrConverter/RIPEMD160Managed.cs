...
{
    // Copied from .Net framework source code. Please refer to the license provided by Microsoft
    // https://referencesource.microsoft.com/#mscorlib/system/security/cryptography/ripemd160managed.cs,1204f8c0bddeff36
    public class RIPEMD160Managed : RIPEMD160
    {
        ...
        internal void DWORDToLittleEndian(byte[] block, uint[] x, int digits)
        {
            int i;
            int j;
