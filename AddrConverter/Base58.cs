...
namespace AddrConverter
{
    ...
    public class Base58
    {
        public Base58(/*ICoin coin*/)// this is part of the Cryptocurrency.Net library
        {
            //b58Chars = coin.Base58Chars;
            //hash = coin.DataHashFunction;
        ...
        private byte[] CalculateCheckSum(byte[] data)
        {
            ...
            {
                return sha.ComputeHash(sha.ComputeHash(data)).SubArray(0, CheckSumSize);
            }
        }
